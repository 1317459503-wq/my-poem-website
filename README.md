[index.html](https://github.com/user-attachments/files/24338822/index.html)
<!DOCTYPE html>
<html lang="zh">
<head>
    <meta charset="UTF-8">
        ...
        <div class="page page-1 active" id="page1">
            <div class="page-content">
                ...
                <div class="line show" style="transition-delay:0.4s">
                    <p style="opacity:0.8; font-size: 18px;">谨以此，送给我心中珍贵的家人<br>最好的朋友林泽满</p >
                </div>
            </div>
            ...
            <div class="page-content">
                ...
                <div class="line" style="transition-delay:1.2s; margin-top: 30px; font-size: 20px;">
                    ...
                    <span style="font-size: 28px; font-weight: bold; 
                        color: #FF6666;
                        text-shadow: 0 0 10px rgba(255, 102, 102, 0.7), 0 0 20px rgba(255, 102, 102, 0.4);
                        display: block;
                        margin-top: 10px;">
                        永不怯懦的副歌。
                    </span>
